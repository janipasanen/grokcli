...
- 2026-03-18: Added interactive task queueing in the shell: Tab and Ctrl+Q now enqueue the current line in TTY mode, queued work is tracked in shell state, and `/queue`, `/queue-show`, `/queue-run`, and `/queue-clear` manage the FIFO queue.
